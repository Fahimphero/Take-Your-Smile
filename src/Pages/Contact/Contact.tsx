            ...
            <div
                ...
                <div data-aos="fade-up"
                    ...
                    <div className="card-body">
                        ...
                        <p className='text-lg text-white flex items-center gap-5'><BsTelephoneOutbound /><span><a href="tel:01881220413" >934534566</a></span></p>
                        <h2 className="card-title text-xl text-white">E-mail</h2>
                        <p className='text-[15px] text-white flex items-center gap-2'><AiOutlineMail /><span ><a href="endgamewarriors6@gmail.com" >endgamewarriors6@gmail.com</a></span></p>
