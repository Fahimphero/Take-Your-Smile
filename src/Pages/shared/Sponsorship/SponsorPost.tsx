                    ...
                    <form className='p-0 flex-row' onSubmit={handleSubmit(onSubmit)}>
                        <div className="card-body">
                            ...
                            <div className="form-control">
                                ...
                                <input type="text" placeholder="Enter Sponsor Title" className="input input-bordered input-primary" {...register("title", {
                                    required: {
                                        value: true,
                            ...
                            <div className="form-control">
                                ...
                                <input type="url" placeholder="Enter Body Image URL" className="input input-bordered input-primary" {...register("url", {
                                    required: {
                                        value: true,
                            ...
                            <div className="form-control">
                                ...
                                <textarea className="textarea textarea-primary h-32" placeholder="Please explain details..." {...register("description", {
                                    required: {
                                        value: true,
