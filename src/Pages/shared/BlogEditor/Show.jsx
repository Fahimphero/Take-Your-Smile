...
const Show = () => {
  ...
  refetch();
  return (
    <div className="overflow-x-hidden sm:overflow-x-hidden bg-gray-700">
      <NavBar />
      <div className=" mx-auto font-sans pt-36">
        <h1
          data-aos="flip-down"
          data-aos-duration="3000"
          className='text-3xl text-center mt-16 font-bold text-white '>All <span className="text-[#fb4051]">Blogs</span></h1>
                ...
                articles.map((item) => (
                  <div className="p-4 md:w-1/3" key={item._id}>
                    <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                      ...
                      <div className="p-6">
                        <h2 className="tracking-widest text-xs title-font font-medium text-white mb-1">Admin</h2>
