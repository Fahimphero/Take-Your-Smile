                      ...
                      <div className="row">
                        <div className="col-lg-6">
                          ...
                          <div className="form-group focused">
                            ...
                            <input type="text" id="input-username" className="fromControl fromControl-alternative" placeholder="Username" {...register("userName", {
                              required: {
                                value: true,
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-6">
                          <div className="form-group focused">
                            ...
                            <input type="text" id="input-phone" className="fromControl fromControl-alternative" placeholder="Phone Number" {...register("phone", {
                              required: {
                                value: true,
